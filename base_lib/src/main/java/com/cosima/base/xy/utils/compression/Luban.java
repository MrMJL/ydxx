package com.cosima.base.xy.utils.compression;
...
import com.cosima.base.xy.utils.FileUtil;
...
public class Luban {
    ...
    private static String DEFAULT_DISK_CACHE_DIR = "smart_path";
    ...
    private static synchronized File getPhotoCacheDir(Context context) {
        ...
        return getPhotoPath(Luban.DEFAULT_DISK_CACHE_DIR);
    }

    private static File getPhotoPath(String cacheName) {
        return FileUtil.createDirect(cacheName);
    }
