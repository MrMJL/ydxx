...
import com.cosima.base.xy.network.BaseResponse;
import com.cosima.base.xy.network.ExceptionHandle;
        ...
        public T apply(BaseResponse<T> response) {
            if (!response.isSuccess()) {
                throw new RuntimeException(
                    response.getErrCode() + "" + response.getErrMsg() != null ? response.getErrMsg()
                        : "");
            }
